...
class SofthreeSplashScreen extends StatefulWidget {
  ...
  factory SofthreeSplashScreen.timer({
  ...
  factory SofthreeSplashScreen.future({
...
class _SplashScreenState extends State<SofthreeSplashScreen> {
  @override
  void initState() {
    super.initState();
